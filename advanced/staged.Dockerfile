...
FROM terrascope-docker-local-prod.repo.vito.be/hadoop-alma9-base:latest AS builder
...
FROM terrascope-docker-local-prod.repo.vito.be/hadoop-alma9-base:latest
